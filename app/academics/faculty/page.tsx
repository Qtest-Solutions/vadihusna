...
const facultyData = [
  { sl: 1, name: "SHEEBA M", designation: "PRINCIPAL", qualification: "M.A, B.Ed", experience: "25 Years" },
  { sl: 2, name: "NASHVA K", designation: "PGT", qualification: "M.Sc (Maths), B.Ed, SET", experience: "11 Years" },
  { sl: 3, name: "SHEENA P", designation: "TGT", qualification: "MA, M.Ed, NET, SET", experience: "18 Years" },
  { sl: 4, name: "BABY VANAJA", designation: "TGT", qualification: "MA, B.Ed", experience: "20 Years" },
  { sl: 5, name: "JYOTHI O P", designation: "TGT", qualification: "MA, B.Ed, SET", experience: "18 Years" },
  { sl: 6, name: "SHEEBA K", designation: "PRT", qualification: "MA, M.Ed", experience: "20 Years" },
  { sl: 7, name: "MUNSHIRA", designation: "PRT", qualification: "BA, B.Ed, PGDCA, KTET", experience: "16 Years" },
  { sl: 8, name: "ASWATHY", designation: "PRT", qualification: "BA-ENG, TTC, B.Ed", experience: "17 Years" },
  { sl: 9, name: "SINDHU K P", designation: "PRT", qualification: "MA-HINDI, B.Ed", experience: "12 Years" },
  { sl: 10, name: "SHIPINA K K", designation: "PGT", qualification: "MSc, B.Ed-Maths", experience: "14 Years" },
  { sl: 11, name: "NASEERA", designation: "TGT", qualification: "MSc, B.Ed", experience: "14 Years" },
  { sl: 12, name: "TIBIN AUGUSTIN", designation: "PET", qualification: "BPEd", experience: "7 Years" },
  { sl: 13, name: "SAJITHA P M", designation: "PRT", qualification: "P.D.C Fashion Designing", experience: "18 Years" },
  { sl: 14, name: "SHABNA P", designation: "TGT", qualification: "B.Ed Mathematics", experience: "3 Years" },
  { sl: 15, name: "ANUSREE T P", designation: "PRT", qualification: "MA-Sociology, MTTC", experience: "2 Years" },
  { sl: 16, name: "MUHAMMED SHAFI K M", designation: "TGT", qualification: "MA-English, ASHARI", experience: "8 Years" },
  { sl: 17, name: "FATHIMATH THASKEENA", designation: "PRT", qualification: "B.Tech", experience: "2 Years" },
  { sl: 18, name: "NOORA JASMINE K C", designation: "PRT", qualification: "B.Tech, MTTC", experience: "2 Years" },
  { sl: 19, name: "SHIBI K P", designation: "PRT", qualification: "B.Com, NTT", experience: "10 Years" },
  { sl: 20, name: "AYISHA T K", designation: "PRT", qualification: "AFSAL-AL-ULAMA", experience: "3 Years" },
  { sl: 21, name: "ASWATHY P K", designation: "PRT", qualification: "MA", experience: "3 Years" },
  { sl: 22, name: "HASNA N K", designation: "PRT", qualification: "DECCE, Diploma in ECE", experience: "3 Years" },
  { sl: 23, name: "MUHAMMED FAVAS P P", designation: "Librarian", qualification: "BA, MLiSc, PGOLAN", experience: "4 Years" },
  { sl: 24, name: "NEETHU V", designation: "PRT", qualification: "MSc, MCA", experience: "4 Years" },
  { sl: 25, name: "SMITHA B", designation: "PRT", qualification: "MA, B.Ed, SET", experience: "23 Years" },
  { sl: 26, name: "JISHA M P", designation: "PRT", qualification: "MA, B.Ed, SET, KTET", experience: "12 Years" },
  { sl: 27, name: "THASNEENA O P", designation: "PRT", qualification: "BSc, B.Ed, MTTC", experience: "4 Years" },
  { sl: 28, name: "FASNA P K", designation: "PRT", qualification: "BA, B.Ed, CTTC", experience: "5 Years" },
  { sl: 29, name: "SHAMSUDHEEN K A", designation: "PGT", qualification: "MA, B.Ed-Arabic", experience: "8 Years" },
  { sl: 30, name: "KRISHNENDU K", designation: "TGT", qualification: "B.Sc, B.Ed-Maths", experience: "7 Years" },
  { sl: 31, name: "SIJI V", designation: "PGT", qualification: "B.Ed", experience: "10 Years" },
  { sl: 32, name: "DHANYA P", designation: "PRT", qualification: "MA, B.Ed, KTET", experience: "10 Years" },
  { sl: 33, name: "NITHINA M", designation: "PRT", qualification: "B.Sc, B.Ed, KTET", experience: "4 Years" },
  { sl: 34, name: "RAMYA T P", designation: "PGT", qualification: "B.Sc, B.Ed, KTET", experience: "5 Years" },
  { sl: 35, name: "DIYA S", designation: "PGT", qualification: "MCA", experience: "8 Years" },
  { sl: 36, name: "UMMUSALMA M V", designation: "PRT", qualification: "MA, B.Ed, TTC, KTET", experience: "8 Years" },
  { sl: 37, name: "RESHMA M K", designation: "PRT", qualification: "BA, B.Ed-Hindi, MTTC", experience: "11 Years" },
  { sl: 38, name: "GRACY JOSEPH", designation: "PRT", qualification: "B.Com, MTTC, MMI", experience: "25 Years" },
  { sl: 39, name: "ANUSREE K", designation: "TGT", qualification: "BA, B.Ed, KTET", experience: "13 Years" },
  { sl: 40, name: "DHANYA V", designation: "PRT", qualification: "MA, B.Ed, KTET", experience: "7 Years" },
  { sl: 41, name: "SAJNA C R", designation: "PET", qualification: "BA, B.PEd", experience: "3 Years" },
  { sl: 42, name: "RINSHA FATHIMA P", designation: "TGT", qualification: "MA, B.Ed", experience: "1 Year" },
  { sl: 43, name: "FATHIMA THAFSEELA", designation: "COUNSELLOR", qualification: "MSc, Psychology", experience: "3 Months" },
  { sl: 44, name: "SARITHA K", designation: "PRT", qualification: "B.Sc, B.Ed, KTET", experience: "8 Years" },
  { sl: 45, name: "ANJALI KRISHNA R S", designation: "PRT", qualification: "MSc, B.Ed", experience: "1 Year" },
  { sl: 46, name: "RASHMI K", designation: "PRT", qualification: "BA, MuSc", experience: "18 Years" },
  { sl: 47, name: "SHAJI V K", designation: "PRT", qualification: "BA, B.Ed", experience: "8 Years" },
  { sl: 48, name: "DIVYA P K", designation: "PRT", qualification: "BA, B.Ed", experience: "4 Years" },
  { sl: 49, name: "ANUPAMA RAJAN", designation: "PGT", qualification: "MA, B.Ed, SET", experience: "7 Years" },
];
    ...
    <main className="bg-slate-50/50 min-h-screen">
      ...
      <div className="container-max py-16 lg:py-24">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 mb-24 reveal reveal-up">
          {[
            { label: "Total Faculty", val: "49", icon: Users },
